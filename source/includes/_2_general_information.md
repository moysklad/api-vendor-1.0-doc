...
+ Пробный период можно также изменить или убрать у уже опубликованных приложений. При этом уже установленные экземпляры  
...
работу платно при наличии свободной опции "Платное приложение". Если у пользователя не окажется  свободных 
опций — приложение будет приостановлено.
