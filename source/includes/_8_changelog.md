...
### 09-12-2024
#### Добавлено
- В инструкцию добавлена возможность [встраивать видео](#vstraiwanie-wideo-w-instrukcii).

### 03-12-2024
#### Добавлено
- В [дескриптор решений](#deskriptor-resheniq) добавлены новые точки встраивания кнопок в карточки Товара, Услуги, Комплекта, Модификации и Группы товаров.

### 21-11-2024
#### Добавлено
- В [дескриптор решений](#deskriptor-resheniq) добавлены новые точки встраивания кнопок в документы Отгрузка, Счет покупателю, Заказ поставщику, Розничная продажа и карточку Контрагента.
