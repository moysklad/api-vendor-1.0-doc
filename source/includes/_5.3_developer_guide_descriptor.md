...
содержимое не умещается в окне браузера по высоте.
...
оповещающий страницу МоегоСклада об изменении высоты его контента. То есть необходимо реализовать отправку сообщения
...
разделе [Кастомные модальные окна](#kastomnye-popapy-modal-nye-okna).
