...
### Пробный пеиод платных приложений
...
Пробный период может быть назначен как для новых приложений, так и для тех, у которых уже есть активные
пользователи. Пробный период активируется только для новых пользователей: им смогут воспользоваться только те, кто еще 
ни разу не устанавливал приложение.

Длительность пробного периода можно установить от 1 до 14 дней. После окончания пробного периода приложение приостанавливается, 
если у пользователя нет свободных опций "Платное приложение". Если пользователь приобретет опцию, то приложение продолжит
 работу.

Приложения с пробным периодом могут быть установлены на любом тарифе и не зависят от наличия опций "Платное приложение"
...
На данный момент пробный период может добавить модератор МоегоСклада по запросу. Позже вендоры смогут 
делать это самостоятельно через [Личный кабинет](#lichnyj-kabinet-wendora).
