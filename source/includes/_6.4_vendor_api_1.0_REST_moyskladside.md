...
При запросах к Apps API обязательно нужно указать в HTTP-заголовке запроса **Accept-Encoding** формат сжатия содержимого — **gzip**. Если указан другой формат, возвращается ошибка 415 Unsupported Media Type (Неподдерживаемый тип данных).
...
+ [Получение контекста пользователя для приложений с iframe-частью, кастомными модальными окнами и виджетами](#poluchenie-kontexta-pol-zowatelq-dlq-prilozhenij-s-iframe-chast-u-popapami-i-widzhetami)

#### Получение или изменение статуса приложения на аккаунте

С помощью этого эндпоинта разработчик может получить или изменить статус приложения пользователя.
...
приложения со стороны разработчика](#rest-andpointy-na-storone-wendora-prilozhenij), разработчик может ответить одним из статусов **Activated**, 
...
`https://apps-api.moysklad.ru/api/remap/1.2/context/employee`.
...
{
  "meta": {
    "href": "https://apps-api.moysklad.ru/api/remap/1.2/entity/employee/b0a02321-13e3-11e9-912f-f3d4002516e3?expand=cashier.retailStore",
    "metadataHref": "https://apps-api.moysklad.ru/api/remap/1.2/entity/employee/metadata",
    "type": "employee",
    "mediaType": "application/json",
    "uuidHref": "https://apps-api.moysklad.ru/app/#employee/edit?id=b0a02321-13e3-11e9-912f-f3d4002516e3"
  },
  "id": "b0a02321-13e3-11e9-912f-f3d4002516e3",
  "accountId": "b0b309ee-13e3-11e9-9109-f8fc0001f188",
  "owner": {
    "meta": {
      "href": "https://apps-api.moysklad.ru/api/remap/1.2/entity/employee/b0a02321-13e3-11e9-912f-f3d4002516e3",
      "metadataHref": "https://apps-api.moysklad.ru/api/remap/1.2/entity/employee/metadata",
      "type": "employee",
      "mediaType": "application/json",
      "uuidHref": "https://apps-api.moysklad.ru/app/#employee/edit?id=b0a02321-13e3-11e9-912f-f3d4002516e3"
  ...
  "group": {
    "meta": {
      "href": "https://apps-api.moysklad.ru/api/remap/1.2/entity/group/b0b3c289-13e3-11e9-9109-f8fc0001f189",
      "metadataHref": "https://apps-api.moysklad.ru/api/remap/1.2/entity/group/metadata",
      "type": "group",
      "mediaType": "application/json"
    }
  },
  ...
  "cashiers": [
    {
      "meta": {
        "href": "https://apps-api.moysklad.ru/api/remap/1.2/entity/retailstore/b0b7cd8d-13e3-11e9-912f-f3d400251724/cashiers/b0b7d387-13e3-11e9-912f-f3d400251725",
        "type": "cashier",
        "mediaType": "application/json"
      }
    }
