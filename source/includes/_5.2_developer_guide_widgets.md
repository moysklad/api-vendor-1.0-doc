...
[https://online.moysklad.ru/app/#embed-apps?id={appId}](https://online.moysklad.ru/app/#embed-apps?id=f0e50ffd-e267-46bf-a963-0adcf2fe09e0).

За настройку и работу этого элемента отвечает [блок iframe в дескрипторе](#blok-iframe). 
В случае отсутствия этого блока считается, что у приложения отсутствует iframe-часть. 
...
контекст пользователя через [Vendor API](#poluchenie-kontexta-pol-zowatelq-dlq-prilozhenij-s-iframe-chast-u-kastomnymi-modal-nymi-oknami-i-widzhetami).
