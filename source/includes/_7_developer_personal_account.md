...
- полноэкранный просмотр видео (атрибут allowfullscreen) не работает в инструкции 
- оптимальный размер видео 640x360 (допускаются любые размеры, но максимальная ширина контента в инструкции 640px)
- при встраивании видео по прямой ссылке предпочтительно использовать mp4, так как он поддерживается большинством современных браузеров
