...
### 13-11-2024
#### Добавлено
- В [дескриптор решений](#deskriptor-resheniq) добавлены новые точки встраивания кнопок в документы (Отгрузка, Счет покупателю, Заказ поставщику, Розничная продажа).
