...
Есть возможность изменить стоимость приложения:
...
Для **неопубликованных** приложений:

Можно изменять стоимость через [Личный кабинет вендора](#lichnyj-kabinet-wendora)
