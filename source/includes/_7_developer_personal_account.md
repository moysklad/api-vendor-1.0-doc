...
| Попробовать               | JavaScript-событие | `external_try_click`          |
| Регистрация               | JavaScript-событие | `external_registration_click` |
| Логин                     | JavaScript-событие | `external_login_click`        |
