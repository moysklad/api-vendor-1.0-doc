...
### Просмотр логов решений

Можно просматривать логи запросов к решениям через интерфейс кабинета разработчика. Логи содержат информацию об основных взаимодействиях по vendor API:
