...
Отчет формируется раз в месяц. **Важно** для формирования отчета должны быть заполнены реквизиты. Отчет доступен для скачивания в виде PDF-файла. Содержит информацию сколько денег заработало каждое приложение в отдельности и суммарно за все приложения за месяц.

**Что важно знать:** 

1. Вендору поступает отчет в статусе Сформировано (на почту приходит оповещение)

2. Вендор ознакамливается с отчетом и согласовывает его – кнопка Согласовать

3. Статус отчета меняется на Согласовано 
   
4. Выплачивается вознаграждение согласно банковским реквизитам вендора и проставляется отметка Выплачено
