...
| [v2](https://online.moysklad.ru/xml/ns/appstore/app/v2/application-v2.xsd)         | Виджеты в документах. Кастомные попапы. Стандартные диалоги. Гибкие права приложений. Протоколы: валидации, навигации, change-handler, update-provider. Селектор групп товаров                                                                          | vendorApi, access(с permissions), iframe(c expand), widgets, popups    | Серверные                                         |
