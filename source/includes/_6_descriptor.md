...
Если указан scope **admin**, то приложение будет работать с правами администратора аккаунта.
...
* В настоящий момент нет отдельной пермиссии на работу с web-хуками. 
