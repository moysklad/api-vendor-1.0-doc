...
за исключением [протокола контекста пользователя](#protokol-konteksta-pol-zowatelq).
...
Рекомендуемый способ получения контекста — [протокол контекста пользователя](#protokol-konteksta-pol-zowatelq):
...
1. Запрашивайте токен у хост-окна по [протоколу контекста пользователя](#protokol-konteksta-pol-zowatelq).
...
* [Протокол контекста пользователя](#protokol-konteksta-pol-zowatelq).
