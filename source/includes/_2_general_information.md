...
Для отладки можно использовать приложение **Loyalty API** (находится первым в блоке Скидки). 
Все остальные приложения по сути являются просто брендированными ссылками со своими копиями настроек. 

Для добавления своего брендированного приложения на витрину пожалуйста пришлите запрос на [apps@moysklad.ru](mailto:apps@moysklad.ru) 
с указанием следующих данных:

1. Логотип квадратный, не менее 300x300 px. Либо залитый цветом по всему периметру, либо с прозрачным фоном. В формате PNG или SVG.
1. Логотип прямоугольный, высота = 35 px, ширина не более 220 px. С прозрачным фоном, в формате PNG или SVG.
