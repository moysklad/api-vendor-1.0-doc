...
+ **Прочие статусы** обрабатываются как ошибка — на странице МоегоСклада выводится сообщение об ошибке с просьбой повторить действие позже.
+ **Таймаут обработки:** если система разработчика не ответила в течение **5 сек**, обработка будет считаться неуспешной и пользователю будет выведена ошибка.
