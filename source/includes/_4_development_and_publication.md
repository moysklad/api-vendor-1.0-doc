...
Серверное приложение — это приложение для взаимодействия с МоимСкладом по JSON API. Для аутентификации JSON API использует access-токен. Чтобы его получить, при разработке приложения необходимо реализовать эндпоинт согласно спецификации [Vendor API 1.0](#vendor-api-1-0).
