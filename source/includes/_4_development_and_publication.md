...
В случае если пользователь выберет один или несколько пунктов и нажмет на кнопку **Отправить отзыв** на email, указанный на вкладке [Вендор](#redaktirowanie-informacii-o-wendore),
