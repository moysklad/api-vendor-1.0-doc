...
Поддержка [сервесных протоколов](#blok-serwisnyh-protokolow-uses) виджетами на страницах создания пока не реализована.
...
Если у пользователя установлены сразу несколько приложений с виджетами, встроенными на одну
 ...
 приложений на витрине. В редакторах контрагентов, товаров, модификаций, услуг, комплектов и групп товаров пользователь может сам поменять порядок
