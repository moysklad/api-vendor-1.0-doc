...
### 10-02-2025
#### Добавлено
- В [дескриптор решений](#deskriptor-resheniq) добавлены новые точки встраивания кнопок: список Платежей (`document.finance.list`).

### 28-01-2025
#### Добавлено
- В [дескриптор решений](#deskriptor-resheniq) добавлены новые точки встраивания кнопок: список Контрагентов (`entity.counterparty.list`).
