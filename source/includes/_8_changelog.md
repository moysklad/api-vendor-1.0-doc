...
### 02-04-2026
#### Добавлено
- В раздел [Внесение изменений в опубликованное решение](#vnesenie-izmenenij-w-opublikowanoe-reshenie) добавлено описание рекомендуемого порядка тестирования и публикации изменений.

#### Изменено
- В разделе [Изображения и видео для страницы решения](#izobrazheniq-i-video-dlq-stranicy-resheniq) уточнены требования к изображениям: разрешение 1280x720–1920x1080 px (16:9), размер файла до 2 Мб.
