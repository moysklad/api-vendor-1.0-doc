...
+ [Получение или изменение статуса приложения на аккаунте](#poluchenie-ili-izmenenie-statusa-prilozheniq-na-akkaunte)
    + [Получение статуса установки приложения на аккаунте](#poluchenie-statusa-ustanowki-prilozheniq-na-akkaunte)
...
##### Получение статуса установки приложения на аккаунте

<u>HTTP-метод</u>: **GET**

<u>Тело запроса</u>: **пустое**

МойСклад при обработке данного запроса проверяет статус установки приложения на аккаунте.

<u>Тело ответа</u>:

В случае успешного ответа возвращается текущий внутренний статус установки приложения с опциональным указанием cause.
...
|:---------|:------:|:-------:|:--------:|
| status | String | Текущий внутренний статус установки приложения | да |
| cause   | String | Последняя команда приложению | нет     |

Таблица соответствия внутренних состояний приложения на аккаунте внешнему статусу установки приложения

| Внутреннее состояние | status | cause |
|:------|:------:|:-----:|
| Installing | Activating | Install |
| Activating[Install] | Activating | Install |
| VendorActivating[Install] | Activating | Install |
| ActivationFailed[Install] | ActivationFailed | Install |
| Settings | SettingsRequired |  |
| Installed | Activated |  |
| Uninstalling | Deactivating | Uninstall |
| Deactivating[Uninstall] | Deactivating | Uninstall |
| DeactivationFailed[Uninstall] | DeactivationFailed | Uninstall |
| Suspending | Deactivating | Suspend |
| Deactivating[Suspend] | Deactivating | Suspend |
| DeactivationFailed[Suspend] | DeactivationFailed | Suspend |
| Suspended | Suspended |  |
| Resuming | Activating | Resume |
| Activating[Resume] | Activating | Resume |
| VendorActivating[Resume] | Activating | Resume |
| ActivationFailed[Resume] | ActivationFailed | Resume |
