...
В случае если пользователь выберет один или несколько пунктов и нажмет на кнопку **Отправить отзыв** на Email службы поддержки вендора, указанный на вкладке [Вендор](#redaktirowanie-informacii-o-wendore),
придет уведомление с указанием причины удаления.
...
Можно управлять уведомлениями через чек-бокс "Отправлять уведомления о причинах удаления приложений на email".
