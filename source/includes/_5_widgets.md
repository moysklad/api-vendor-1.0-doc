...
#### Куда сейчас можно встраивать виджеты и какие протоколы там поддерживаются?

Узнать можно в разделе [Точки встраивания и доступные в них протоколы](#tochki-wstraiwaniq-i-dostupnye-w-nih-protokoly)
...
В случае, если виджет поддерживает протокол **open-feedback**, система не отображает 
 ...
 он оповещается об изменениях, получая сообщение `Change`, содержащее несохраненное состояние документа.
...
Для этого в дескрипторе для виджета нужно объявить поддержку опционального протокола **change-handler**.
 ...
 Узнать, для каких точек поддерживается протокол **change-handler**, можно [тут](#tochki-wstraiwaniq-i-dostupnye-w-nih-protokoly).
