...
На данный момент для встраивания виджетов доступны страницы редактирования:
...
На данный момент для встраивания виджетов доступны страницы создания:

- Заказ покупателя (_document.customerorder.create_)

Во всех точках расширения на страницах редактирования виджеты имеют одинаковый функционал. За исключением документа Заказ покупателя - только в этой точке поддерживается протокол `change-handler`.

Виджеты в точках расширения на страницах создания имеют урезанный функционал относительно виджетов в точках расширения на страницах редактирования того же документа. 
Виджеты на **страницах создания** и виджеты на **страницах редактирования** одного документа являются независимыми. 
