...
Также есть возможность внести или отредактировать реквизиты для выплат вендору. Для этого потребуется перейти на вкладку 
**Реквизиты** в верхнем меню Личного кабинета.
