...
если у пользователя нет свободных опций "Платное приложение". Когда пользователь приобретет опцию — приложение продолжит
 работу.
...
На данный момент пробный период может добавить вашему приложению модератор МоегоСклада по запросу. Позже вендоры смогут 
