...
приложения обладают ограниченными возможностями и на данный момент представляют "пробный" этап перед ожидаемым 
переводом приложения в тип "Серверное".

 Для iframe-приложений **не поддерживается** активация и деактивация по Vendor API, а также получение контекста 
