...
- фиксированной шириной: 416px - для виджета, 384px - для iframe.
...
### Анатомия виджетов: из чего состоит виджет и как он работает

#### Описание конфигурации виджетов приложения в дескрипторе

Виджеты доступны для серверных приложений с дескриптором версии от 2.0.0 и выше. 

Пример дескриптора приложения с виджетом в карточке контрагента:

> Дескриптора приложения с виджетом в карточке контрагента
...
в дескрипторе для виджета надо явно указать поддержку дополнительного протокола **open-feedback**.
...
виджета для отображения пользователю:
