...
| [2.28.0](https://online.moysklad.ru/xml/ns/appstore/app/v2/application-2.28.0.xsd) | Поддержка протокола навигации (`<navigation-service/>`) в главном iframe приложения и popup'ах | vendorApi, access(с permissions), iframe(c expand), widgets, popups | Серверные |
