...
9. Если решение поддерживает работу с оплатой по QR-коду, реализуйте на своей стороне поддержку [QrPay API](https://dev.moysklad.ru/doc/api/qr-pay/1.0).

10. [Разместите](#uslowiq-razmescheniq-reshenij) решение в каталоге решений или как приватное с возможностью установки только по прямой ссылке. Режим распространения (публичное/приватное) выбирается при отправке на модерацию. После прохождения модерации изменить режим будет невозможно.
