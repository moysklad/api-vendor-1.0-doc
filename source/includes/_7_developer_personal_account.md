...
* При скрытии бесплатного тарифа, нельзя выбрать новый бесплатный тариф. Если вы хотите вернуть Бесплатный, его необходимо восстановить.
* Скрытые тарифы можно не отображать в редакторе тарифов: для этого снимите флажок **Показывать скрытые тарифы**.
* Скрытые тарифы продолжают участвовать в валидации: даже если тариф скрыт, нельзя создать другой тариф с таким же названием или ценой.  
