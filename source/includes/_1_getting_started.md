...
Для демонстрации способов взаимодействия решений разработчиков с МоимСкладом был создан демо-проект на PHP.

В этом проекте реализован следующий набор функций:
...
* Использование основного окна для настройки решения администратором аккаунта с обновлением статуса в каталоге решений
* Получение контекста пользователя: отображение информации о пользователе, проверка прав администратора
* Работа с виджетами через JS Widget SDK — см. раздел [SDK для виджетов](#sdk-dlq-widzhetow).
