...
Для того чтобы отслеживать посещения страницы решения и строить воронку продаж нужно указать ИД счетчика [Яндекс Метрики](https://metrika.yandex.ru/) на странице редактирования черновика **Серверного** решения. 
Если уже есть существующий счетчик можно использовать его, либо создать новый.

Для отслеживания событий на витрине МоегоСклада необходимо добавить следующие **цели** в настройках Яндекс Метрики:
