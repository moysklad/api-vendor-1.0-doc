...
### 02-09-2026
#### Добавлено
- Добавлен [протокол user-context](#protokol-user-context) для запроса одноразового токена контекста пользователя из главного окна, виджета или модального окна.
...
#### Изменено
- Получение контекста пользователя по `contextKey` помечено как устаревшее. Оба способа работают параллельно.
...
#### Изменено
- В разделе [Изображения и видео для страницы решения](#izobrazheniq-i-wideo-dlq-stranicy-resheniq) уточнены требования к изображениям: разрешение 1280x720–1920x1080 px (16:9), размер файла до 2 Мб.
