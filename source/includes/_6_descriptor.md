...
| [v2](https://online.moysklad.ru/xml/ns/appstore/app/v2/application-v2.xsd)         | [Виджеты](#vidzhety) в документах и сущностях. Кастомные попапы (модальные окна). Пермиссии приложений. Дополнительные и сервисные протоколы.                                                                                                                        | vendorApi, access(с permissions), iframe(c expand), widgets, popups    | Серверные                                         |
