...
- **Серверное приложение**. Дескриптор приложения обязателен для заполнения. Правила заполнения дескриптора смотрите в разделе [Дескриптор приложения](#deskriptor-prilozheniq).
...
По умолчанию все приложения создаются с одним бесплатным тарифом. Для изменения стоимости приложения предназначен раздел **Создание и редактирование тарифов** на вкладке **Тарифы**. 

Для добавления тарифа нажмите кнопку **Добавить новый тариф** и заполните его поля:

- **Название тарифа**. Должно быть кратким и давать представление о сути тарифного плана. Примеры: Старт, Корпоративный, Бизнес и т.д. Для приложений с одним тарифом не выводится на витрине.
...
Подробнее о выборе стоимости приложений в разделе [Условия оплаты приложений](#uslowiq-oplaty-prilozhenij).
