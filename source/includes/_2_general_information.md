...
которое вы указали, но не более 14. При этом, предоставленный для продления пробный период накладывается на активный.
...
Предоставляемый для продления период не суммируется с количеством дней пробного периода, которое уже есть у аккаунта.

Кроме продления пробного периода, в ЛКВ можно предоставить пробный период для случаев, когда пользователь не может самостоятельно подключить пробный период. Или когда в настройках у приложения пробный период отсутствует.

Если для приложения на выбранном аккаунте недоступна функция **предоставить пробный период**, то система выдаст ошибку. 
Ошибки могут возникнуть в следующих случаях:

+ Аккаунт не найден в МоемСкладе.
+ Приложение бесплатное или не опубликовано.
+ На аккаунте есть активный пробный период. Вы указали меньшее количество дней. Уменьшать количество дней пробного периода недопустимо.
+ У приложения на аккаунте уже продлевали пробный период. Повторно воспользоваться данной функцией на аккаунте невозможно.
+ На аккаунте есть активная оплаченная подписка. В данном статусе продление пробного периода недопустимо.
+ Приложение на данном аккаунте находится в статусе установки. Нужно дождаться окончания текущей установки, и повторить действие.
