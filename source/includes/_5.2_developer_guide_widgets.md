...
> Дескриптор приложения, iframe-часть и модальное окно которого используют стандартные диалоги
...
```
Позволяет виджетам, iframe-части и модальным окнам приложений осуществлять переход на другую страницу МоегоСклада и открывать МойСклад в новой вкладке. 
