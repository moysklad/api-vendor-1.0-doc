...
### 02-09-2026
#### Добавлено
- Добавлен [протокол контекста пользователя](#protokol-konteksta-pol-zowatelq) для запроса одноразового токена контекста пользователя из главного окна, виджета или модального окна.
