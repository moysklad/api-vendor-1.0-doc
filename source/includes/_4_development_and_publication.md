...
Для просмотра отчета по установкам необходимо перейти в раздел **Отчеты** в верхнем меню.
...
Данный отчет предоставляет информацию по тому сколько приложение заработало денежных средств, динамику увеличения продаж приложения. Учитываются только реально оплачиваемые установки. Установки на Пробном тарифе и с Пробным периодом приложений не учитываются.
...
Отчет формируется раз в месяц, доступен для скачивания в виде PDF-файла. Содержит информацию сколько денег заработало каждое приложение в отдельности и суммарно за все приложения за месяц.

**Что важно знать:** 

1. Для формирования отчета должны быть заполнены реквизиты.

2. Вендору поступает отчет в статусе Сформировано (на почту приходит оповещение)

3. Вендор ознакамливается с отчетом и согласовывает его – кнопка Согласовать

4. Статус отчета меняется на Согласовано 
   
5. Выплачивается вознаграждение согласно банковским реквизитам вендора и проставляется отметка Выплачено
