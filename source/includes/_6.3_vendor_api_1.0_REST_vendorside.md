...
`Uninstall` означает удаление решения с аккаунта. Данные установки при этом можно удалить в соответствии с политикой хранения данных разработчика, а можно сохранить — тогда при повторной установке пользователю не придется настраивать решение заново. Подробнее — в разделе [Сохранение настроек при приостановке решения](#sohranenie-nastroek-pri-priostanowke-resheniq).
