...
| access       | Array  | Текущие права у приложения на аккаунте | Да                      |
...
| scope       | String | Набор прав, может быть **admin** или **custom**                                            | Да                      |
| permissions | String | Список Документов (supply) и бинарных прав (viewDashboard), структуру см. в примере справа | Да (для custom)         |
