...
**Витрина приложений** - отдельный экран МоегоСклада, на котором размещаются опубликованные приложения. Доступна по адресу [https://online.moysklad.ru/app/#apps](https://online.moysklad.ru/app/#apps) (только пользователям с правами администратора).
