...
Об ограничениях и разрешениях, применяемых к iframe решений, читайте в разделе [Ограничения для контента, загружаемого в виджетах](#ogranicheniq-dlq-kontenta-zagruzhaemogo-w-widzhetah).
