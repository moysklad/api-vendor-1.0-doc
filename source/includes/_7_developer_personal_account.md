...
После загрузки изображения будут храниться на нашем сервере и будут видны на странице решения на витрине МоегоСклада (перед текстовым описанием) в уменьшенном размере.
При нажатии пользователем на уменьшенном изображении оно откроется в полном размере.
