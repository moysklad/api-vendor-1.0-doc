...
Об ограничениях и разрешениях iframe читайте в разделе [Ограничения для контента, загружаемого в виджетах](#ogranicheniq-dlq-kontenta-zagruzhaemogo-w-widzhetah).
...
|--------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `allow-top-navigation`                     | Прямая навигация top-level страницы запрещена — вендор не может программно перенаправить пользователя со страницы МоегоСклада. Для навигации по страницам МоегоСклада используйте протокол [navigation-service](#protokol-nawigacii) |
