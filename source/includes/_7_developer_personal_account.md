...
<body>
    ...
    ...
    <h2 id="online-order-1">Установка приложения</h2>
    ...
    <h2 id="online-order-2">Создание ссылки на каталог товаров</h2>
    ...
    <h3 id="online-order-2-1">Создать общедоступную ссылку на каталог товаров</h3>
    ...
    ...
    <h3 id="online-order-2-2">Создать ссылку на каталог для конкретного контрагента</h3>
    ...
    <h2 id="online-order-3">Настройка валют</h2>
    ...
</body>
</html>
```
...
2. Файл инструкции должен называться index.html и находиться в корне архива. Наличие других html-файлов в арихиве не допускается.
3. Для автоматического построения содержания html-файл должен содержать в себе теги `<h2>` с уникальными идентификаторами.
4. Файлы картинок могут находиться как в корне, так и в папках внутри архива.
