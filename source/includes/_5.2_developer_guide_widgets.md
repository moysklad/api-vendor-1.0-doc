...
| `allow-top-navigation-to-custom-protocols` | Запрещена навигация на кастомные протоколы (`tel:`, `mailto:` и др.). Решление не должно инициировать открытие сторонних приложений из контекста МоегоСклада без контроля платформы.                                                      |
