...
которое включает в себя НДС 22% (180,33 рублей), то разработчик получит за него 614,75 рублей за этот период.
...
1. Заполните [реквизиты компании](https://apps.moysklad.ru/cabinet/bankdetails), обязательно укажите ставку НДС (без НДС, 5%, 7%, 22% или «Не применимо», если ваша компания не является резидентом РФ).
