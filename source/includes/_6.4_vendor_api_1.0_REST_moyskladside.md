...
Признак администратора аккаунта — `permissions.admin.view == "ALL"`. Подробнее смотрите в таблице [«Пользовательские и тарифные пермиссии»](https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-obschie-swedeniq-permissii-sotrudnika-pol-zowatel-skie-i-tarifnye-permissii) JSON API 1.2.
