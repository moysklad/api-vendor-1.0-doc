...
виджетом. На данный момент в нем можно указать только тег **open-feedback**. Подробнее про протокол
**open-feedback** можно прочитать в разделе [Виджеты](#zhiznennyj-cikl-widzheta).
