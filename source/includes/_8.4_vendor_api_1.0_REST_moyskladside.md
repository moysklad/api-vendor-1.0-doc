...
##### Таблица возможных статусов установки приложения

| status | cause | Что означает
|:------:|:-----:|:-------:|
| Activating | Install | Установка приложения
| ActivationFailed | Install | Неудачная установка приложения
| SettingsRequired |  | Требуются настройки
| Activated |  | Приложение успешно установлено на аккаунт
| Deactivating | Uninstall | Удаление приложения
| DeactivationFailed | Uninstall | Удаление приложения прошло неудачно
| Deactivating | Suspend | Приостановка приложения
| DeactivationFailed | Suspend | Не удалось деактивировать приложение
| Suspended |  | Приложение приостановлено на аккаунте
| Activating | Resume | Возобновление работы приложения
| ActivationFailed | Resume | Неудачное возобновление работы приложения
