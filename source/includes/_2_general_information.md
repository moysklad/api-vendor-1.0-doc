...
В данный момент приложение может запросить следующие уровни доступа:
...
* **admin** - соответствует пользовательской роли `Системный администратор`: приложение получит полный доступ ко всем отчетам, сущностям и документам в МоемСкладе.
 Этот уровень **не рекомендуется** для использования обычными приложениями и нужен только для приложений работающих с web-хуками и Задачами.
