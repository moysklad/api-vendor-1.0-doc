...
500 рублям в месяц. Эта оплата взимается с пользователей в виде платной опции в рамках их подписки на МойСклад — "Опция платных приложений", 
...
работу платно при наличии "Опции платных приложений" в количестве, требуемом для оплаты приложения.
